...
class GrxPagingBeforeAfter extends Component {
    render() {
        ...
        var html = ids.map(
            (v,i) => <a href="javascript:;" onClick={this.props.actions.pagingAction.bind(this, pagingIndex)} title={title}>..</a>
        )
...
class GrxPagingNumber extends Component {
    render(){
        ...
        return(
            <a href="javascript:;" onClick={this.props.actions.pagingAction.bind(this, pagingIndex)} title={title}> {text} </a>
        )
    }
}
